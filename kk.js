    ...
    paper.addEventListener('touchmove', (e) => {
      ...
      if (this.touchPoints.length >= 2) {
        ...
        if (this.holdingPaper) {
          ...
          // Keep paper within viewport bounds
          this.currentPaperX = Math.max(-100, Math.min(window.innerWidth - 100, this.currentPaperX));
          this.currentPaperY = Math.max(-100, Math.min(window.innerHeight - 100, this.currentPaperY));
